...
HD_PWD='C:/Users/rebec/Desktop/Automobile_Mirror_Display_system/Automobile_Mirror_Display_system.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mirror_Display_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mirror_Display_1.tcl
